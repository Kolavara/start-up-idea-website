      ...
      <div className="relative z-[2] max-w-[1360px] mx-auto min-h-[100dvh] flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 pt-16 pb-8 text-center">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl font-medium text-white max-w-[580px] leading-relaxed mb-4 drop-shadow-xl [text-shadow:_-1px_-1px_0_rgba(0,0,0,0.8),_1px_-1px_0_rgba(0,0,0,0.8),_-1px_1px_0_rgba(0,0,0,0.8),_1px_1px_0_rgba(0,0,0,0.8)]"
          >
